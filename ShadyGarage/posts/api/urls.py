...
urlpatterns = [
    ...
    url(r'^comments/(?P<slug>[-\w]+)/$', views.PostCommentListAPIView.as_view(), name="posts-detail-comment-list"),
    url(r'^create_post/$', views.PostCreateAPIView.as_view(), name="api-create-post"),
