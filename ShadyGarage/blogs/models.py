...
class Blog(models.Model):
    ...
    paragraph_two_image  = models.ImageField(upload_to="blogs/paragraph_3", blank=True, null=True)
    paragraph_two_image_mobile  = models.ImageField(upload_to="blogs/mobile/paragraph_3",blank=True, null=True)
    second_parallax        = models.ImageField(upload_to="blogs/parallax_2", blank=True, null=True)
